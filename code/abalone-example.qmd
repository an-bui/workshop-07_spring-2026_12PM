...
# base layer: ggplot
ggplot(data = abalone_clean, # adding data
...
**At pH = 8, the model predicts change in abalone shell surface area to be 5.36 [95% CI: 5.08, 5.64] mm^2^ d^-1^.**
